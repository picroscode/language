...
return [
	...
	'index.title' => 'Picros Rounder App | Pop-up Manager',
	'index.meta_description' => 'Sales Messages from Mini-Applications are also supported. Embedded website for notification widgets, ideal for enhancing conversion on your own website. ',
	'index.meta_keywords' => 'Picros Rounder',
	'index.header' => 'Anytime Message <br />from <span class="text-primary">Rounders</span>',
	'index.subheader' => 'Send messages from Whatapp-applications are also <br />supported. Embedded website for notification widgets, <br />ideal for enhancing conversion on your own website. <br /><strong>Total %s notifications</strong>',

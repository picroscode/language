...
return [
	...
	'global.plan_settings.replaced_images_per_month_limit' => '%s AI replaced bg. images / month',
	...
	'index.menu' => 'Home',
	'index.title' => 'Picros.xyz | AD Creative Service',
	'index.meta_description' => 'Specialized service for creating and editing exceptional advertising content. Enhance your ads with captivating texts, images, and sound. Let\'s create impactful ad content.',
	'index.meta_keywords' => 'picros xyz',
	'index.header' => 'Ad <span class="text-gradient-primary" style="--gradient-one: var(--pink); --gradient-two: var(--indigo);">Creation</span> & Design',
	'index.subheader' => 'Enhance your ads with captivating texts, images, and sound. Let\'s create impactful ad content.',
	'index.register' => 'Sign up for free',
	'index.feature.one' => '50+ AI types',
	...
	'index.chats.messages.one' => 'Hi, can you please tell me what can Studio Picros do for you?',
	'index.chats.messages.two' => 'Studio Picros provides Saas(Software-as-a-Service) solutions to solve web issues. Other services include creative production and commissioned coding of static sites for unique UI/UX experiences.',
	'index.chats.messages.three' => 'What is the best way to promote your business with a website?',
	'index.chats.messages.four' => 'Before you start doing anything complicated with your Web site, start by providing basic information. For your customers, your Web site is a way to get to know you. There is no need to prepare a complicated system. Studio Picros can provide tools and consultation to assist you, starting with your website. Please contact us for more information.',

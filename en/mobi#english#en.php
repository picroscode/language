...
return [
  ...
  'global.emails.user_welcome.body' => 'Hey there <strong>{{NAME}}</strong>,<br /><br />We want to salute you and welcome you to our website community!<br /><br /><a href="{{URL}}">Visit our homepage</a><br /><br />Greetings from {{WEBSITE_TITLE}}.',
	...
	'qr_codes.input.url_dynamic_help' => 'Enabling this will create a QR code that points to an internal short link, which will redirect to any specified link, dynamically. The short links you create can be changed later.',
	...
	'index.menu' => 'Home',
	'index.title' => 'Picros.mobi | QR code Delivery Service',
	'index.meta_description' => 'Dynamic QR code app for easy QR campaign management. Customize and change destination URL anytime. Connect your own unique domain. ',
	'index.meta_keywords' => 'picros.mobi',
	'index.header' => 'QR code delivery',
	'index.subheader' => 'Dynamic QR code app for easy QR campaign management. Customize and change destination URL anytime. Connect your own unique domain. ',
	...
	'index.privacy.header' => 'Data storage',
